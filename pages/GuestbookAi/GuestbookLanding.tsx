  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      {settings.backgroundImage ? (
        ...
        <div className="absolute inset-0 z-0 bg-gradient-to-b from-[#bc13fe]/20 to-[#050505]" />
      )}
        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#bc13fe] transition-colors resize-none"
          ...
          <button
            ...
            className="mt-4 w-full py-4 bg-[#bc13fe] hover:bg-[#a010d8] disabled:bg-gray-600 disabled:cursor-not-allowed text-white rounded-xl font-bold text-lg transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#bc13fe]/20"
          >
